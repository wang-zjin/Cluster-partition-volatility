%% 做VaR的预测failure rate，用不同时间，输出到text
...
ftxt=fopen('results_Files/VaRPrediction2018_20220205t.txt','a+');
TableMatrix=tableVaRPredict(EGARCHclusterVaR1,logRet,outsampleStart,outsampleEnd,ConfidenceLevel);
writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205t.csv','Delimiter',',','QuoteStrings',true,'WriteRowNames',true)
writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205t.csv','Delimiter',',','QuoteStrings',true,'WriteRowNames',true,'WriteVariableNames',false)
writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205t.txt','Delimiter',',','QuoteStrings',true,'WriteRowNames',true)
writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205t.txt','Delimiter',',','QuoteStrings',true,'WriteRowNames',true,'WriteVariableNames',false)

writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205a.txt','WriteRowNames',true)
writetable(TableMatrix,'results_Files/VaRPrediction2018_20220205a.txt','WriteMode','Append','WriteVariableNames',false,'WriteRowNames',true) 
%                           CL1       CL2      CL3      CL4     CL5      CL6     CL7     Accuracy
